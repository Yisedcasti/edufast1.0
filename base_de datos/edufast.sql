...
CREATE TABLE IF NOT EXISTS `Edufast`.`docente` (
  ...
  `registro_rol_id_rol` INT NOT NULL,
  `registro_jornada_id_jornada` INT NOT NULL,
  PRIMARY KEY (`id_docente`, `registro_num_doc`, `registro_rol_id_rol`, `registro_jornada_id_jornada`),
...
CREATE TABLE IF NOT EXISTS `Edufast`.`materia` (
  ...
  PRIMARY KEY (`id_materia`, `area_id_area`),
...
CREATE TABLE IF NOT EXISTS `Edufast`.`logro` (
  ...
  PRIMARY KEY (`grado_id_grado`, `id_logro`, `materia_id_materia`),
  INDEX `fk_logro_grado1_idx` (`grado_id_grado` ASC),
  INDEX `fk_logro_materia1_idx` (`materia_id_materia` ASC),
  ...
  CONSTRAINT `fk_logro_materia1`
    ...
    REFERENCES `Edufast`.`materia` (`id_materia`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Edufast`.`docente_has_materia` (
  ...
  `materia_id_materia` INT NOT NULL,
  PRIMARY KEY (`docente_id_docente`, `materia_id_materia`),
  INDEX `fk_docente_has_materia_materia1_idx` (`materia_id_materia` ASC),
  INDEX `fk_docente_has_materia_docente1_idx` (`docente_id_docente` ASC),
  CONSTRAINT `fk_docente_has_materia_docente1`
    FOREIGN KEY (`docente_id_docente`)
    REFERENCES `Edufast`.`docente` (`id_docente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `Edufast`.`actividad` (
  ...
  `docente_has_materia_docente_id_docente` INT NOT NULL,
  `docente_has_materia_materia_id_materia` INT NOT NULL,
  `logro_grado_id_grado` INT NOT NULL,
  `logro_id_logro` INT NOT NULL,
  `logro_materia_id_materia` INT NOT NULL,
  PRIMARY KEY (`id_actividad`, `docente_has_materia_docente_id_docente`, `docente_has_materia_materia_id_materia`, `logro_grado_id_grado`, `logro_id_logro`, `logro_materia_id_materia`),
  INDEX `fk_actividad_docente_has_materia1_idx` (`docente_has_materia_docente_id_docente` ASC, `docente_has_materia_materia_id_materia` ASC),
  INDEX `fk_actividad_logro1_idx` (`logro_grado_id_grado` ASC, `logro_id_logro` ASC, `logro_materia_id_materia` ASC),
  CONSTRAINT `fk_actividad_docente_has_materia1`
    FOREIGN KEY (`docente_has_materia_docente_id_docente` , `docente_has_materia_materia_id_materia`)
    REFERENCES `Edufast`.`docente_has_materia` (`docente_id_docente` , `materia_id_materia`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_actividad_logro1`
    FOREIGN KEY (`logro_grado_id_grado` , `logro_id_logro` , `logro_materia_id_materia`)
    REFERENCES `Edufast`.`logro` (`grado_id_grado` , `id_logro` , `materia_id_materia`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Edufast`.`nota` (
  ...
  PRIMARY KEY (`id_nota`, `matricula_id_matricula`, `actividad_id_actividad`),
  INDEX `fk_nota_matricula1_idx` (`matricula_id_matricula` ASC),
  INDEX `fk_nota_actividad1_idx` (`actividad_id_actividad` ASC),
  CONSTRAINT `fk_nota_matricula1`
    FOREIGN KEY (`matricula_id_matricula`)
    REFERENCES `Edufast`.`matricula` (`id_matricula`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_nota_actividad1`
    FOREIGN KEY (`actividad_id_actividad`)
    REFERENCES `Edufast`.`actividad` (`id_actividad`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Edufast`.`Observacion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Edufast`.`Observacion` (
  `idObservacion` INT NOT NULL AUTO_INCREMENT,
  `fechaCompromiso` DATE NULL,
  `observacion` CHAR(120) NULL,
  `compromiso` CHAR(120) NULL,
  `nombre_docente` CHAR(45) NULL,
  `firma_docente` LONGBLOB NULL,
  `observador_id_observador` INT NOT NULL,
  `estudiante_id_estudiante` INT NOT NULL,
  `estudiante_registro_num_doc` INT NOT NULL,
  `estudiante_registro_rol_id_rol` INT NOT NULL,
  `estudiante_registro_jornada_id_jornada` INT NOT NULL,
  PRIMARY KEY (`idObservacion`, `observador_id_observador`, `estudiante_id_estudiante`, `estudiante_registro_num_doc`, `estudiante_registro_rol_id_rol`, `estudiante_registro_jornada_id_jornada`),
  INDEX `fk_Observacion_observador1_idx` (`observador_id_observador` ASC),
  INDEX `fk_Observacion_estudiante1_idx` (`estudiante_id_estudiante` ASC, `estudiante_registro_num_doc` ASC, `estudiante_registro_rol_id_rol` ASC, `estudiante_registro_jornada_id_jornada` ASC),
  CONSTRAINT `fk_Observacion_observador1`
    FOREIGN KEY (`observador_id_observador`)
    REFERENCES `Edufast`.`observador` (`id_observador`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Observacion_estudiante1`
    FOREIGN KEY (`estudiante_id_estudiante` , `estudiante_registro_num_doc` , `estudiante_registro_rol_id_rol` , `estudiante_registro_jornada_id_jornada`)
    REFERENCES `Edufast`.`estudiante` (`id_estudiante` , `registro_num_doc` , `registro_rol_id_rol` , `registro_jornada_id_jornada`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `Edufast`.`boletin` (
  ...
  `puesto` CHAR(10) NULL,
  `fechaBoletin` DATE NULL,
  `añoBoletin` CHAR(10) NULL,
  `Observacion_idObservacion` INT NOT NULL,
  `nota_id_nota` INT NOT NULL,
  `nota_matricula_id_matricula` INT NOT NULL,
  `nota_actividad_id_actividad` INT NOT NULL,
  PRIMARY KEY (`id_boletin`, `Observacion_idObservacion`, `nota_id_nota`, `nota_matricula_id_matricula`, `nota_actividad_id_actividad`),
  INDEX `fk_boletin_Observacion1_idx` (`Observacion_idObservacion` ASC),
  INDEX `fk_boletin_nota1_idx` (`nota_id_nota` ASC, `nota_matricula_id_matricula` ASC, `nota_actividad_id_actividad` ASC),
  CONSTRAINT `fk_boletin_Observacion1`
    FOREIGN KEY (`Observacion_idObservacion`)
    REFERENCES `Edufast`.`Observacion` (`idObservacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_boletin_nota1`
    FOREIGN KEY (`nota_id_nota` , `nota_matricula_id_matricula` , `nota_actividad_id_actividad`)
    REFERENCES `Edufast`.`nota` (`id_nota` , `matricula_id_matricula` , `actividad_id_actividad`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `Edufast`.`docente_has_cursos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Edufast`.`docente_has_cursos` (
  `docente_id_docente` INT NOT NULL,
  ...
  PRIMARY KEY (`docente_id_docente`, `docente_registro_num_doc`, `docente_registro_rol_id_rol`, `docente_registro_jornada_id_jornada`, `cursos_id_cursos`, `cursos_grado_id_grado`),
  INDEX `fk_docente_has_cursos_cursos1_idx` (`cursos_id_cursos` ASC, `cursos_grado_id_grado` ASC),
  INDEX `fk_docente_has_cursos_docente1_idx` (`docente_id_docente` ASC, `docente_registro_num_doc` ASC, `docente_registro_rol_id_rol` ASC, `docente_registro_jornada_id_jornada` ASC),
  CONSTRAINT `fk_docente_has_cursos_docente1`
    FOREIGN KEY (`docente_id_docente` , `docente_registro_num_doc` , `docente_registro_rol_id_rol` , `docente_registro_jornada_id_jornada`)
    REFERENCES `Edufast`.`docente` (`id_docente` , `registro_num_doc` , `registro_rol_id_rol` , `registro_jornada_id_jornada`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_docente_has_cursos_cursos1`
