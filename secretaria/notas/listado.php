...
?>
            <div class="container mt-5">
                <h1 class="text-center text-white mb-4">Listado de Notas por Curso</h1>
    ...
    function updateTable() {
        ...
        filteredData.forEach(item => {
            ...
            row.innerHTML = `
                ...
                <td>${item.materia ?? 'N/A'}</td>
                <td>${item.nombre_logro ?? 'N/A'}</td>
                <td>${item.nombre_act ?? 'N/A'}</td>
                <td>${item.nota ?? 'N/A'}</td>
                <td>${item.fecha_nota ?? 'N/A'}</td>
            `;
